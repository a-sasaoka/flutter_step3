...
import 'package:helloworld/scanner_error_widget.dart';
...
class BarcodeScannerWithScanWindow extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _BarcodeScannerWithScanWindowState();
}
...
class _BarcodeScannerWithScanWindowState
  ...
  Future<void> onDetect(BarcodeCapture barcodeCapture) async {
    ...
    if (!_isScan) {
      _isScan = true;
      log('type:${barcodeCapture.barcodes.first.type}');
      log('format:${barcodeCapture.barcodes.first.format}');
      log('');
      Navigator.pop(
          context, '読み込んだ値: ${barcodeCapture.barcodes.first.rawValue}');
    }
  }
